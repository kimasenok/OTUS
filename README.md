...
3. Не загружается виртуальная машина CentOS8. Решение - Включение Nested Virt - Set-VMProcessor -VMName "CentOS_OTUS" -ExposeVirtualizationExtensions $true
4. Проблема с подключению к репозиторию elrepo в ВМ CentOS8.
Решение:
